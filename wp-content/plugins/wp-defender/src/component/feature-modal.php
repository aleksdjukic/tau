	...
	*/
	...
	public function get_dashboard_modals(): array {
		...
		/* translators: %s: separator */
			__( "NEW: Manage global IPs with the Hub", 'wpdef' ),
			'<br/>'
		);
		$desc = __( 'You can now create and manage a global IP allowlist and blocklist in your Hub, and sync those lists with any connected website you want.', 'wpdef' );
		...
		return [
			...
			'welcome_modal' => [
				...
				'banner_alt' => __( 'Modal for Global IP lists', 'wpdef' ),
				'button_title' => __( 'Manage Global Ips', 'wpdef' ),
