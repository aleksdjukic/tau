...
?></label>
                        <?php 
echo  wp_kses( wc_help_tip( esc_html__( 'Enable or Disable', 'woocommerce-conditional-product-fees-for-checkout' ) ), array(
...
?>
                        ...
                        <?php 
echo  wp_kses( wc_help_tip( esc_html__( 'This product fees title is visible to the customer at the time of checkout.', 'woocommerce-conditional-product-fees-for-checkout' ) ), array(
    'span' => $allowed_tooltip_html,
) ) ;
?>
                    </th>
...
esc_attr_e( 'Enter product fees title', 'woocommerce-conditional-product-fees-for-checkout' );
?>">
					</td>
				</tr>
				<tr valign="top">
...
?>
                        ...
                        <?php 
echo  wp_kses( wc_help_tip( esc_html__( 'You can charges extra fees on fixed price or percentage.', 'woocommerce-conditional-product-fees-for-checkout' ) ), array(
    'span' => $allowed_tooltip_html,
) ) ;
?>
					</th>
...
?>
                        ...
                        <?php 
echo  wp_kses( wc_help_tip( esc_html__( 'You can add fixed/percentage fee based on selection above.', 'woocommerce-conditional-product-fees-for-checkout' ) ), array(
    'span' => $allowed_tooltip_html,
) ) ;
?>
                    </th>
...
?>
                        ...
                        <?php 
echo  wp_kses( wc_help_tip( esc_html__( 'Select Start date on which you want to enable the method', 'woocommerce-conditional-product-fees-for-checkout' ) ), array(
    'span' => $allowed_tooltip_html,
) ) ;
?>
					</th>
...
?>
                        ...
                        <?php 
echo  wp_kses( wc_help_tip( esc_html__( 'Select End date on which you want to disable the method', 'woocommerce-conditional-product-fees-for-checkout' ) ), array(
    'span' => $allowed_tooltip_html,
) ) ;
?>
					</th>
...
?>">
				...
				<tr valign="top">
					<th class="titledesc" scope="row">
						<label for="fee_settings_select_taxable"><?php 
				...
				<tr valign="top">
					<th class="titledesc" scope="row">
						<label for="ds_select_day_of_week">
                            <?php 
esc_html_e( 'Days of the Week', 'woocommerce-conditional-product-fees-for-checkout' );
?>
                        </label>
                        <?php 
$html = sprintf(
...
?>
						<select name="ds_select_day_of_week[]" id="ds_select_day_of_week" class="ds_select_day_of_week multiselect2 wcpfc_select" multiple="multiple" placeholder='<?php 
echo  esc_attr( 'Select days of the Week', 'woocommerce-conditional-product-fees-for-checkout' ) ;
?>'>
							<?php 
...
?>' autocomplete="off">
						...
						<a href="javascript:void(0)" class="ds_reset_time"><?php 
esc_html_e( 'Reset time', 'woocommerce-conditional-product-fees-for-checkout' );
?></a>
					</td>
				</tr>
				</tbody>
...
if ( isset( $productFeesArray ) && !empty($productFeesArray) ) {
    ...
    foreach ( $productFeesArray as $key => $productfees ) {
        ...
        if ( 'cart_total' === $fees_conditions || 'cart_totalafter' === $fees_conditions || 'cart_specificproduct' === $fees_conditions || 'quantity' === $fees_conditions || 'weight' === $fees_conditions || 'product_qty' === $fees_conditions ) {
            ?>
        ...
        if ( 'country' === $fees_conditions ) {
            ...
            $html .= sprintf( wp_kses( __( '<p><b style="color: red;">Note: </b> Make sure enter each city name in one line.', 'woocommerce-conditional-product-fees-for-checkout' ), array(
                'p' => array(),
                'b' => array(
                'style' => array(),
            ),
