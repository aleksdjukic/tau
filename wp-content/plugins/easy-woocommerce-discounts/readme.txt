=== Discount Rules and Dynamic Pricing for WooCommerce - woocommerce discount plugin for woocommerce bulk discount, woocommerce coupons, category discount, percentage discount, storewide discount, scheduled coupons, auto apply coupon, woocommerce quantity discount, shipping methods, free shipping, tiered discount ===
...
All purpose WooCommerce discount plugin, WooCommerce pricing and discounts, WooComemrce advanced discounts, advanced shipping, promotion tools plugin.

== Description ==

Use [Discount Rules and Dynamic Pricing for WooCommerce](https://www.asanaplugins.com/product/woocommerce-dynamic-pricing-and-discounts-plugin/?utm_source=wp-org&utm_campaign=easy-woocommerce-discounts&utm_medium=link) to create bulk discounts, cart discounts, percentage discounts, advanced discounts, dynamic pricing, product quantity based discounts, dynamic shipping methods and advanced shipping methods for WooCommerce. [WooCommerce Dynamic Pricing & Discounts - Easy WooCommerce Discounts](https://www.asanaplugins.com/product/woocommerce-dynamic-pricing-and-discounts-plugin/?utm_source=wp-org&utm_campaign=easy-woocommerce-discounts&utm_medium=link) plugin offers well-defined solutions to help you set the best discount offers on your WooCommerce store. It’s easy and works out of the box for beginners, and has advanced features for professional users.

Use [Easy WooCommerce Discounts - WooCommerce Dynamic Pricing & Shipping](https://www.asanaplugins.com/product/woocommerce-dynamic-pricing-and-discounts-plugin/?utm_source=wp-org&utm_campaign=easy-woocommerce-discounts&utm_medium=link) to set discounts on products, categories and cart and also create dynamic shipping methods.

Use [WooCommerce Dynamic Pricing](https://www.asanaplugins.com/product/woocommerce-dynamic-pricing-and-discounts-plugin/?utm_source=wp-org&utm_campaign=easy-woocommerce-discounts&utm_medium=link) plugin to create WooCommerce pricing, dynamic pricing, advanced pricing and pricing based on product quantity rules.

Use [WooCommerce Dynamic Shipping](https://www.asanaplugins.com/product/woocommerce-dynamic-pricing-and-discounts-plugin/?utm_source=wp-org&utm_campaign=easy-woocommerce-discounts&utm_medium=link) plugin to create advanced shipping, free shipping, weight based shipping methods and cart total based shipping methods easily.

[WooCommerce Bulk Discounts](https://www.asanaplugins.com/woocommerce-bulk-discounts/?utm_source=wp-org&utm_campaign=easy-woocommerce-discounts&utm_medium=link) increase your sales by encouraging users to buy more quantities. Use WooCommerce Discount Rules free plugin to create one easily.
...
== WooCommerce Dynamic Pricing & Discounts Plugin Features (Available In The Free Version) ==
...
* <strong>[WooCommerce Cart Discount Rules](https://www.asanaplugins.com/how-to-create-cart-discount-in-woocommerce-easily/) | [Video Tutorial](https://youtu.be/ECWdimYEMM0)
* <strong>Percentage based discounts in WooCommerce</strong>
* <strong>Store wide global discount or set a discount to WooCommerce all products</strong>
* <strong>Quantity based discount or range based discount or bulk pricing discount (Example: Buy 2 to 5 with 5% discount, 6 to 10 with 10% discount, 11 to 15 with 20% discount, 16 and greater with 25% discount)</strong>
* <strong>Display quantity discount table on product page</strong>
* <strong>Product based discount to set discounts on specific products</strong>
* <strong>Scheduled product discounts</strong>
* <strong>Cart based percentage discount or WooCommerce cart discount (Example: Get 20% discount on Black Friday or get 15% discount on specific date)</strong>
* <strong>WooCommerce cart total based discount (Example: Spend more than $500, get 20% discount)</strong>
* <strong>Advanced WooCommerce cart discount rules</strong>
* <strong>Scheduled WooComemrce coupons</strong>
* <strong>Order total based discount</strong>
* <strong>Exclude selected products from discount rules (product price based rules)</strong>
* <strong>Date based discount (validity)</strong>
* <strong>Show discount table or bulk table or quantity table on the product pages</strong>
* <strong>A shortcode for quantity based discount table or bulk pricing table</strong>
* <strong>Option to set rules expiry date (From Date , To Date)</strong>
* <strong>Create advanced WooCommerce shipping methods or WooCommerce dynamic shipping methods</strong>
* <strong>Create WooCommerce weight based shipping methods</strong>
* <strong>Create WooCommerce free shipping method based on cart total amount condition</strong>
* <strong>Create WooCommerce shipping method based on cart total amount</strong>
* <strong>Create WooCommerce shipping method based on number of cart items</strong>
* <strong>Create WooComemrce shipping method based on date or date period</strong>
* <strong>WooComemrce shipping method cost based on cart weight</strong>
* <strong>WooComemrce shipping method cost based on cart total amount</strong>
* <strong>WooComemrce shipping method cost per quantity</strong>
* <strong>WooComemrce shipping method cost per weight</strong>
* <strong>Scheduled WooCommerce shipping methods</strong>

**[Easy WooCommerce Discounts Pro with 50% discount for $30](https://www.asanaplugins.com/product/woocommerce-dynamic-pricing-and-discounts-plugin/?utm_source=wp-org&utm_campaign=easy-woocommerce-discounts&utm_medium=link)**

== WooCommerce Dynamic Pricing ==
Are you looking for a way to increase sales in your WooCommerce store? WooCommerce Dynamic Pricing is a way that can help you to do it. Dynamic pricing rules allow you to create different prices based on conditions, cart quantities, cart totals, product quantities and etc. You can use dynamic pricing to create price discounts, percentage discounts, quantity based discount, bulk discounts or tiered discounts in your WooCommerce store.

== WooCommerce Percentage Discounts ==
Discounts are really interesting for everyone and percentage discounts are the most common type of discounts for stores. Some of the most common percentage discounts are 10% or 50% discounts.
WooCommerce dynamic pricing and discount rules free plugin has great features to create percentage discounts on products and percentage coupons.

== WooCommerce Quantity Based Discounts ==
WooCommerce Bulk Discounts or quantity based discounts or tiered discounts is the best way to boost your store sales and encourage your store clients to buy large quantities of an item from your store and increase your sales.

== WooCommerce Smart Coupons ==
Create WooCommerce smart coupons that adds advanced features to WooCommerce coupons like auto apply coupons, scheduled coupons, coupons based on specific products, percentage coupon discount, coupon based on cart total, coupon based on cart quantities or number of cart items.

== Advanced WooCommerce Shipping Methods =
Create advanced WooCommerce shipping methods based on rules like free shipping based on cart total, free shipping based on cart weight, cost per weight, cost per quantity and dynamic shipping methods.

== 📕 PRO VERSION Tutorials and Features ==
* <strong>[Dynamic Pricing and Discounts for WooCommerce](https://www.asanaplugins.com/how-to-use-dynamic-pricing-in-woocommerce/)</strong>
* <strong>[WooCommerce percentage discounts](https://www.asanaplugins.com/how-to-create-woocommerce-percentage-discounts/) | [Video Tutorial](https://youtu.be/W5hwOb5tflw)</strong>
...
* <strong>[WooCommerce Cart Discount Rules](https://www.asanaplugins.com/how-to-create-cart-discount-in-woocommerce-easily/) | [Video Tutorial](https://youtu.be/ECWdimYEMM0)</strong>
* <strong>Buy 3 Get 1 Free in WooCommerce</strong>
* <strong>[Buy A Get B Discounted](https://youtu.be/FxbnrqUnhYI)</strong>
...
* <strong>[WooCommerce Bulk Discounts](https://www.asanaplugins.com/woocommerce-bulk-discounts/?utm_source=wp-org&utm_campaign=easy-woocommerce-discounts&utm_medium=link) | [Video Tutorial](https://youtu.be/hm77PqMcA_0)</strong>
...
* <strong>[Create discount for WooCommerce product variations](https://www.asanaplugins.com/how-to-create-discounts-for-product-variations-in-woocommerce/) | [Video Tutorial](https://youtu.be/vIFE3yPGIkc)</strong>
* <strong>[Create discount for WooCommerce categories](https://www.asanaplugins.com/how-to-create-woocommerce-category-discounts/) | [Video Tutorial](https://youtu.be/11_LJBTvgng)</strong>
* <strong>[Create discount for WooCommerce product attributes](https://www.asanaplugins.com/how-to-create-woocommerce-product-attributes-discounts/)</strong>
* <strong>Create discount for WooCommerce tags</strong>
* <strong>Create User Role Based Discounts in WooCommerce</strong>
* <strong>Create Black Friday or Cyber Mondey discount deals in WooComemrce</strong>
* <strong>Create WholeSale discounts in WooCommerce</strong>
* <strong>Dependant product based discounts (Buy Product A and get discount on Product B)</strong>
* <strong>Purchase history based discount (Customers who spent $100 in previously get 10% discount)</strong>
* <strong>Discount based on the number of orders placed earlier (Example: 10% discount for customers with 5 or more orders)</strong>
* <strong>Create coupons or discounts for specific customers in WooCommerce</strong>
* <strong>[WooCommerce First Order Discount Rule](https://www.asanaplugins.com/how-to-give-first-order-discount-in-woocommerce/)</strong>
* <strong>[WooCommerce discount for payment methods](https://youtu.be/Kmi8ezXUnLU)</strong>
* <strong>[woocommerce Discount for specific Shipping states](https://youtu.be/jJtZ5de1568)</strong>
* <strong>Create shipping or delivery location based discounts in WooCommerce</strong>
* <strong>Advanced WooCommerce Checkout Fees</strong>
* <strong>Display live discounted price</strong>
* <strong>Create Advanced WooCommerce Coupons</strong>
* <strong>Create Advanced WooCommerce Shipping Methods</strong>
...
* <strong>Fixed price discounts (Get 10$ discount for purchasing over 6 items).</strong>
* <strong>User role based dynamic pricing and discounts for WooCommerce store (Example: Wholesale customers get a discounted price).</strong>
* <strong>Set Discount for WooCommerce All Products or WooCommerce Global Discount.</strong>
* <strong>WooCommerce User Role Based Discount</strong>
* <strong>[WooCommerce category based discount rules](https://www.asanaplugins.com/how-to-create-woocommerce-category-discounts/)</strong>
* <strong>WooComemrce Customer Based Discount</strong>
* <strong>WooCommerce Signup Discount Plugin</strong>
* <strong>WooCommerce Discount Manager Plugin</strong>
...
* <strong>[WordPress WhatsApp Chat](https://wordpress.org/plugins/live-chat-button/)
...
* <strong>[WhatsApp Chat Pro for WordPress & WooCommerce](https://www.asanaplugins.com/product/whatsapp-chat-wordpress/?utm_source=wp-org&utm_campaign=easy-woocommerce-discounts-free&utm_medium=link)
...
3. Cart discount based on cart subtotal - Get 10% discount when subtotal is greater than 100£.
4. Simple pricing discount - Apply 10% discount on Cap when subtotal is greater than £50.
...
* Adding items to cart discounts to apply discount to the specified items in the cart.
